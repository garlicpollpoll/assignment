...
public interface BorrowRepository extends JpaRepository<Borrow, Long> {
    ...
    @Query("select bo from Borrow bo join fetch bo.members m join fetch bo.book b where m.username = :username and b.id = :bookId")
    Optional<Borrow> findMyBook(@Param("username") String username, @Param("bookId") Long bookId);
}
